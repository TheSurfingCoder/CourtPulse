...
describe('CourtModel', () => {
    ...
    describe('findAll', () => {
        it('should return all courts', async () => {
            ...
            const result = await Court_1.CourtModel.findAll();
        ...
        it('should handle database errors', async () => {
            ...
            await expect(Court_1.CourtModel.findAll()).rejects.toThrow('Database connection failed');
        });
    });
    describe('findById', () => {
    ...
    describe('create', () => {
        it('should create a new court', async () => {
            ...
            expect(mockPool.query).toHaveBeenCalledWith(expect.stringContaining('INSERT INTO courts'), ['New Court', 'tennis', -73.9851, 40.7589, 'New Address', 'clay', true]);
        });
    });
    describe('findByType', () => {
