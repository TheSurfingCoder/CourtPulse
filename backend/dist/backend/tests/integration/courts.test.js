...
const courts_1 = __importDefault(require("../../src/routes/courts"));
...
app.use('/api/courts', courts_1.default);
...
describe('Courts API Integration Tests', () => {
    ...
    beforeAll(async () => {
        ...
        database.default.query = database_1.testPool.query.bind(database_1.testPool);
    });
    ...
    describe('GET /api/courts/type/:type', () => {
        it('should return courts by type', async () => {
            ...
            await database_1.testPool.query(`
      ...
      `, ['Test Court', 'basketball', -73.9851, 40.7589, 'Test Address', 'asphalt', true]);
            ...
            const testCourt = response.body.data.find((court) => court.name === 'Test Court');
    ...
    describe('GET /api/courts/:id', () => {
        ...
        it('should return court by valid ID', async () => {
            ...
            // Insert test court
            const result = await database_1.testPool.query(`
        INSERT INTO courts (enriched_name, sport, centroid, address, surface_type, is_public)
        VALUES ($1, $2, ST_SetSRID(ST_MakePoint($3, $4), 4326), $5, $6, $7)
        RETURNING id
      `, ['Test Court', 'basketball', -73.9851, 40.7589, 'Test Address', 'asphalt', true]);
    ...
    describe('POST /api/courts', () => {
        ...
        it('should create court with valid data', async () => {
            ...
            const dbResult = await database_1.testPool.query('SELECT * FROM courts WHERE enriched_name = $1', ['New Court']);
    ...
    describe('DELETE /api/courts/:id', () => {
      ...
      `, ['Court to Delete', 'basketball', -73.9851, 40.7589, 'Test Address', 'asphalt', true]);
            ...
            const dbResult = await database_1.testPool.query('SELECT * FROM courts WHERE id = $1', [courtId]);
...
//# sourceMappingURL=courts.test.js.map